...
CURRENTDIR=`pwd`
MAINFILE="font-uploader-free.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/font-uploader" # Remote SVN repo on wordpress.org, with no trailing slash
