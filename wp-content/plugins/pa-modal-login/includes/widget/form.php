...
<p>
    <label for="login-text"><?php _e('Login Text:', 'pressapps'); ?></label>
...
<p>
    <label for="logout-text"><?php _e('Logout Text:', 'pressapps'); ?></label>
...
<p>
    <label for="show-admin"><?php _e('Show Admin Link:', 'pressapps'); ?></label>
