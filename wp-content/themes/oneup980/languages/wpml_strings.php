...
PeGlobal::$config["wpml_strings"] = array(
    "WPML - Conditional",
    ...
    "Usually, text content has a maximum width set (which depends on the theme but usually around 980px) and gets centered. Use 'Full Width' settings if you want the block to fill the whole container, for instance to add full width content using a shortcode.",
