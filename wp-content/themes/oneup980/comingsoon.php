...
<div id="main">
    ...
    <div class="wrap">
        ...
        <div class="content">
            <!-----start-logo--------->
            <div class="logo-404">
                <h1><a href="<?php echo get_home_url(); ?>"><img src="<?php bloginfo('template_directory'); ?>/404-css/images/coming.png"/></a></h1>
                <span><img src="<?php bloginfo('template_directory'); ?>/404-css/images/signal.png"/>We are Still Working on it.</span>
            </div>
            <!-----end-logo--------->
