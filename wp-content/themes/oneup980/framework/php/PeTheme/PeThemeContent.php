    ...
    public function media() {
        ...
        switch ($format) {
            case "gallery":
                $gallery = empty($meta->gallery) ? false : $meta->gallery;
                if (!empty($gallery->id)) {
                    $conf = $this->master->view->create(
                            $gallery->type, "gallery", array("id" => $gallery->id), $gallery->width, $gallery->height
                    );
