...
class PeThemeViewDirection extends PeThemeViewBlog {

    public function name() {
        return __("Direction Aware Hover Effect", 'Pixelentity Theme/Plugin');
    }

    public function short() {
        return __("Direction", 'Pixelentity Theme/Plugin');
    }
    ...
    public function mbox() {
        ...
        $mbox["content"] = array(
            ...
            array(
                ...
                "description" => __("<b>Fixed</b>: all grid cell will have the same width/height.<br><b>Variable</b>: will use the cell layout defined in the project direction settings.", 'Pixelentity Theme/Plugin'),
                "type" => "RadioUI",
                "options" =>
                array(
    ...
    public function template($type = "") {
        if ($type != "empty") {
            peTheme()->get_template_part("view", "direction");
        }
    }
